...
| Chronological accepted decisions                | [`docs/DECISIONS.md`](DECISIONS.md)                                                                                                                                              | Latest entries D61-D74 cover the current 0.2D fixture, runner, report, closure and next-task selection work. |
