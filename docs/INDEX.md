...
| Chronological accepted decisions                | [`docs/DECISIONS.md`](DECISIONS.md)                                                                                                                                              | Latest entries D61-D77 cover the current 0.2D closure, development protocol and candidate registration.                         |
...
| 0.2B qualification registry                     | [`../src/simulator/component-qualification-registry.ts`](../src/simulator/component-qualification-registry.ts)                                                                   | Immutable C1/C2/AB2 history plus the dormant replacement candidate; C2 remains the default.                                     |
