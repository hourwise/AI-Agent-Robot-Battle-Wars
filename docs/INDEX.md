...
| Chronological accepted decisions                | [`docs/DECISIONS.md`](DECISIONS.md)                                                                                                                                              | Latest entries D61-D75 cover the current 0.2D closure and 0.2B replacement-evidence governance.                           |
